...
using namespace planetbosch;

void Diffuser::Init(float sample_rate) {
  engine_.Init(buffer_);
  engine_.SetLFOFrequency(LFO_1, 0.3f / sample_rate);
  lp_decay_ = 0.0f;
  ...
  typedef E::Reserve<
      ...
      E::Reserve<
          ...
          E::Reserve<
              269,
              E::Reserve<
                  444, E::Reserve<1653, E::Reserve<2010, E::Reserve<3411>>>>>>>
                          Memory;
