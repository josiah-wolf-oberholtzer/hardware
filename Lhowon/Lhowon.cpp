...
public:
    ...
    void Process(float in_1, float in_2, float* out) {
        buffer_[0] = daisysp::SoftClip((in_1 * !muted_) + (feedback_[0] * feedback_level_));
        buffer_[1] = daisysp::SoftClip((in_2 * !muted_) + (feedback_[1] * feedback_level_));
